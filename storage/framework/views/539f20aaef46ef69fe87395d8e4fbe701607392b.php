...
<div class="container "style="padding-top:85px;">
  ...
  <table class="table table=bordered table-hover">
    ...
    <tr>
      ...
      <?php  }?>
      <?php  }?>
      <a class="btn btn-sm btn-info" href="<?php echo e(url('/customer')); ?>">Back</a>
</div>

    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mikrotik\resources\views/customerDetail.blade.php ENDPATH**/ ?>